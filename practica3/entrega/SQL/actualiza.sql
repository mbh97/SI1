...
ALTER TABLE
  imdb_directormovies
ADD
  FOREIGN KEY (directorid) REFERENCES imdb_directors(directorid) ON DELETE CASCADE;
ALTER TABLE
  imdb_directormovies
ADD
  FOREIGN KEY (movieid) REFERENCES imdb_movies(movieid) ON DELETE CASCADE;
...
-- Creacion
DROP
  TABLE IF EXISTS imdb_genres CASCADE;
...
DROP
  TABLE IF EXISTS imdb_countries CASCADE;
...
DROP
  TABLE IF EXISTS imdb_languages CASCADE;
...
ALTER TABLE
  imdb_moviegenres
ADD
  COLUMN genreid INTEGER CONSTRAINT imdb_moviegenres_genreid_fkey REFERENCES imdb_genres(genreid) ON DELETE CASCADE;
ALTER TABLE
  imdb_moviecountries
ADD
  COLUMN countryid INTEGER CONSTRAINT imdb_moviecountries_countryid_fkey REFERENCES imdb_countries(countryid) ON DELETE CASCADE;
ALTER TABLE
  imdb_movielanguages
ADD
  COLUMN languageid INTEGER CONSTRAINT imdb_movielanguages_languageid_fkey REFERENCES imdb_languages(languageid) ON DELETE CASCADE;
--Actualiza tablas
UPDATE
  imdb_moviegenres
SET
...
-- Not null
ALTER TABLE
  customers ALTER COLUMN firstname
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN lastname
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN address1
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN city
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN country
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN region
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN creditcardtype
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN creditcardexpiration
DROP
  NOT NULL;
ALTER TABLE
  customers ALTER COLUMN username
DROP
  NOT NULL;
--Alert
DROP
  TABLE IF EXISTS alerta CASCADE;
CREATE TABLE alerta(
